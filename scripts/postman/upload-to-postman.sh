...
# Usage: POSTMAN_API_KEY=... scripts/postman/upload-to-postman.sh
...
# Files
COLLECTION_FILE="$PROJECT_ROOT/docs/BPAS1.postman_collection.json"
COLLECTION_NAME="BPAS1 Backend (MVP)"
ENV_FILE_PROJECT="$PROJECT_ROOT/docs/BPAS1.postman_environment.json"
...
main() {
  ...
  maybe_upload_environment "$api_key" "$ENV_FILE_PROJECT"
}
